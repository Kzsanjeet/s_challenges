...
// Set the cityInput value to "Solihull"
cityInput.value = 'Solihull';
...
pastDataButton.addEventListener("click", () => {
  ...
  fetch("BalbirSinghThapa_2358204.php")
...
async function saveWeatherDataToDatabase(city, data) {   // this function helps to save weather data to a database by making an HTTP POST request to a PHP script (weather.php)
    return fetch("BalbirSinghThapa_2358204.php", {
      method: "POST",
      headers: {
